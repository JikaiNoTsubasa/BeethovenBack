...
public class DocumentManager(BeeDBContext context, FileManager fileManager, GlobalParameterManager globalParameterManager): BeeManager(context)
{
    ...
    public async Task<Document> CreateDocument(string name, IFormFile file, long userId, long? entityId = null)
    {
        ...
        string documentStoragePath = _globalParameterManager.GetParameterValue(BeeApplicationConstants.PARAM_DOCUMENT_STORAGE_PATH, "documents");
    ...
    {
        string luceneIndexPath = _globalParameterManager.GetParameterValue(BeeApplicationConstants.PARAM_LUCENE_INDEX_PATH, "lucene/index");
